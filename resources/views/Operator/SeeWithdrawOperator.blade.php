    ...
    <section class="d-flex justify-content-center ">
        <div class="container bg-dark-content p-5 rounded-card">
            <div class="d-flex justify-content-center text-white col-12">
                <a class="btn btn-secondary btn-not-active-left" href="/operator-seeDeposite">Deposite</a>
                <a class="btn btn-primary btn-active-right" href="/operator-seeWithdraw">Withdraw</a>
            </div>
                ...
                <div class="col-12">
                    <div class="login-wrap p-0">
                        <form action="#" class="signin-form ">
                            ...
                            <div class="form-group">
                                <input id="" type="text" class="form-control rounded-pill py-3 px-4"
                                    placeholder="Rp 10.000.000" name="withdraw_value" disabled>
                            </div>
